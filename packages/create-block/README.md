...
_Currently this is a direct copy of `@wordpress/create-block`, the intent is to modify it for TypeScript Gutenberg development._

Create Block is an **officially supported tool for scaffolding a WordPress plugin that registers a block**. It generates PHP, TS, CSS code, and everything you need to start the project. It also integrates a modern build setup with no configuration.
