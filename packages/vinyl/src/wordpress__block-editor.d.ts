/**
 * I don't know why [types](../../../types/wordpress__block-editor/index.d.ts)
 * directory isn't being picked up by TypeScrip, but this is.
 */
export module '@wordpress/block-editor' {
	declare namespace MediaReplaceFlow {
		interface Props {
   ...
   * This component should be used as a child of a <BlockControls> component.
	 */
	export declare const MediaReplaceFlow: {
		(props: MediaReplaceFlow.Props): JSX.Element;
	};

	export declare const __experimentalGetElementClassName: ( element: string ) => string
}
