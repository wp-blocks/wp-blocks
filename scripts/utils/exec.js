 ...
 * @param {SpawnOptions} options - Options to pass to `cross-spawn`.
 * @return {Promise<void>} Returns a Promise which resolves when `command` exits. If the exit code is non-zero, it rejects with the exit code.
 */
